  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
          ...
          <div className="space-y-3 sm:space-y-6 text-center sm:text-left">
            ...
            <div className="flex justify-center sm:justify-start">
              <Link href="/analyze" className="w-full sm:w-auto">
                <Button size="lg" className="gap-2 w-full h-14 sm:w-auto text-body7 sm:text-body5 bg-black text-white hover:bg-black/90">
                  → 교통사고 분석하기
                </Button>
              </Link>
            </div>
      ...
      <section className="container mx-auto px-4 sm:px-10 py-8 sm:py-20 max-w-7xl">
        ...
        <div className="bg-gray-100 rounded-lg aspect-video flex items-center justify-center text-gray-500 min-h-36 sm:max-h-[360px] mx-auto">
          ...
          {[
            ...
            <Card key={index} className={index === 2 ? "sm:col-span-2 md:col-span-1" : ""}>
              <CardHeader>
                ...
                <CardDescription className="text-body8 sm:text-body4">{review.comment}</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="flex items-center gap-3">
                  <div className="w-16 h-16 rounded-full bg-muted flex items-center justify-center text-lg">{review.avatar}</div>
                  <div>
      ...
      <section className="py-8">
        <div className="container mx-auto px-4 sm:px-10 py-10 text-center space-y-3 sm:space-y-6 max-w-7xl bg-gray-900 sm:bg-gray-800">
          <h2 className="text-title4 sm:text-title1 text-gray-0 leading-tight">지금 바로 Acci의 과실비율을 확인해보세요</h2>
          ...
          <Link href="/analyze" className="inline-block w-full sm:w-auto">
            <Button size="lg" variant="secondary" className="gap-2 sm:w-auto text-sm sm:text-body7 bg-white text-gray-900 hover:bg-gray-100">
              시작하기
            </Button>
          </Link>
        </div>
